    ...
    public class InvoiceService : IInvoiceService
    {
        ...
        Guid tenantId, Guid userId, CreateInvoiceDto dto, CancellationToken ct = default)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ApiResponse<InvoiceDto>.Fail("Failed to create invoice. Please try again.");
            }
        }
            ...
            Guid tenantId, int month, int year, CancellationToken ct = default)
        {
            ...
            var hsnSummary = invoices
                ...
                .Select(g => new GSTHSNSummaryDto(
                    ...
                    g.Sum(i => i.IGSTAmount + i.CGSTAmount + i.SGSTAmount + i.CessAmount)));

            var statewiseSummary = invoices
                .Where(i => i.IsInterState && !string.IsNullOrEmpty(i.PlaceOfSupply))
                ...
                .Select(g => new GSTStatewiseSummaryDto(
                    ...
                    g.Sum(i => i.TaxableAmount), g.Sum(i => i.IGSTAmount), g.Count()));
